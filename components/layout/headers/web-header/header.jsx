...
import logo1 from "../../../../public/assets/img/logo_hkbp_no_background.png";
import logo2 from "../../../../public/assets/img/logo_hkbp_no_background.png";
import MobileMenuPopup from '../mobile-menu/menu-area';
import Link from 'next/link';

const HeaderWeb = ({variant}) => {
            ...
            <div className="custom__container">
                <div className="row">
                    <div className="col-xl-5 col-md-5">
                        ...
                        <Link href="https://maps.app.goo.gl/xAFS6J9NKZTvUESN9"><i className="fas fa-map-marker-alt"></i>Naposobulung HKBP Tanung Mulia Medan Deli</Link>
                        </div>
                    </div>
                    <div className="col-xl-7 col-md-7">
                        <div className="top__bar-left">
                            <span><i className="fas fa-clock"></i>Working Hours : 08AM - 11PM</span>
                            <Link href="mailto:nhkbptanjungmulia@gmail.com"><i className="fas fa-envelope"></i>nhkbptanjungmulia@gmail.com</Link>
                        </div>
                    </div>
                </div>
            </div>
